...
public class StatisticsController {
	...
	//	Query
	Student_AvgHomeworks averageHomeworksCourseClassQueryCart = new Student_AvgHomeworks();
	averageHomeworksCourseClassQueryCart.getCart().setName("AverageHomeworksCourseClass");
	//	Query
	Student_AvgAttendance forCourseClassAverageAttendanceQueryCart = new Student_AvgAttendance();
	forCourseClassAverageAttendanceQueryCart.getCart().setName("ForCourseClassAverageAttendance");
	//	Query
	Student_AvgTimeDeliveryHomeworks forCourseClassAverageTimeDeliveryHomeworksQueryCart = new Student_AvgTimeDeliveryHomeworks();
	forCourseClassAverageTimeDeliveryHomeworksQueryCart.getCart().setName("ForCourseClassAverageTimeDeliveryHomeworks");
	//	Query
	Student_HomeworkScoreSeries forCourseClassSeriesScoresHomeworksQueryCart = new Student_HomeworkScoreSeries();
	forCourseClassSeriesScoresHomeworksQueryCart.getCart().setName("ForCourseClassSeriesScoresHomeworks");
	//	Query
	Student_ExamScoreSeries seriesScoreExamsQueryCart = new Student_ExamScoreSeries();
	seriesScoreExamsQueryCart.getCart().setName("SeriesScoreExams");
	
	AbstractCart[] cartsArray = {
		(averageHomeworksCourseClassQueryCart).getCart(),
		(forCourseClassAverageAttendanceQueryCart).getCart(),
		(forCourseClassAverageTimeDeliveryHomeworksQueryCart).getCart(),
		(forCourseClassSeriesScoresHomeworksQueryCart).getCart(),
		(seriesScoreExamsQueryCart).getCart()
	};
	...
	q1.getCart().setName("Professor_NumberCourses");
	...
	q2.getCart().setName("Professor_ForYearLectureByWeekDaySingleProfessor");
	...
	q3.getCart().setName("Professor_ForYearAvgLectureByWeekDaySingleProfessor");
	...
	q8.getCart().setName("Professor_AvgTimeDeliveryHomework");
	...
	q9.getCart().setName("Professor_AvgScoreHomework");
	...
	q10.getCart().setName("Professor_AvgAttendanceAllStudent");
	...
	q11.getCart().setName("Professor_AvgAttendanceSingleStudent");
