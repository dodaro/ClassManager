...
*/
public class ComboDualAxesCart extends AbstractCart {
public ComboDualAxesCart(){
super();
this.setName("ComboDualAxesCart");
}
...
{
cartScript.append("\n");
cartScript.append("text: \'Average Monthly Temperature and Rainfall in Tokyo\'\n");
cartScript.append("}");
}
cartScript.append(",\n");
