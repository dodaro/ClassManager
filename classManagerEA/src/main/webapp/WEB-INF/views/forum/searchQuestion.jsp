													...
													<div class="panel-title">
														<div>
															<div role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne"> 
															 <h4><b>Form ricerca domanda</b></h4>
															</div>
														</div>
													</div>
												</div>
													...
													<div class="panel-body">
														...
														<form:form commandName="searchSettings" action="searchQuestion" method="POST">
															...
															<div class="form-group">
																<label for="questionNameInp">Question name</label> 
																<form:input path="questionName" type="text" class="form-control" id="questionNameInp" placeholder="insert question name..." ></form:input>
															</div>

															<div class="form-group">
																<label for="descriptionInp">Contains in description</label>
																<form:input path="questionDescription" type="text" class="form-control" id="descriptionInp" placeholder="insert description..."></form:input>
															</div>

															<div class="form-group">
																<label for="authorInp">Author</label>
																<form:input path="username" type="text" class="form-control" id="authorInp" placeholder="insert author name..."></form:input>
															</div>
