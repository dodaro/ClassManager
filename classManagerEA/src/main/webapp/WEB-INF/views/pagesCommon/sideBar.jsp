...
<li><a href="#"><span class="glyphicon glyphicon-folder-open"></span> Materials</a></li>
...
<li>
	<a href="./noticeboard?init=1">
		<span class="glyphicon glyphicon-send"></span> 
		<spring:message	code="message.noticeboard" text="default text" /> con fake init
	</a>
</li>
<li>
	<a href="./noticeboard">
	<span class="glyphicon glyphicon-send"></span> 
	<spring:message code="message.noticeboard" text="default text" /> senza init
	</a>
</li>