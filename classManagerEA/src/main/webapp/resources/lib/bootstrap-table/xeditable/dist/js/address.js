    ...
    $.extend(Address.prototype, {
        ...
        **/
        value2html: function(value, element) {
            ...
            var html = $('<div>').text(value.score + praise).html();
            $(element).html(html); 
        },
       ...
       **/         
       value2input: function(value) {
           ...
           this.$input.filter('[name="praise"]').prop('checked', value.praise);
       },       
       ...
       **/          
       input2value: function() { 
           return {
              ...
              praise: this.$input.filter('[name="praise"]').is(':checked')
           };
       },        
       ...
       **/        
       activate: function() {
            this.$input.filter('[name="score"]').focus();
       },  
